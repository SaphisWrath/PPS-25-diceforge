...
object MissionDescriptions:
  private val descMap: Map[String, (String, String)] = Seq(
    ...
    ("minotaur", ("Minotauro", s"Ottieni 8 $gloryPoint; tutti gli altri giocatori lanciano i l$gold dadi, ma perdono le risorse determinate dal lancio dei dadi invece di guadagnarle")),
    ...
    ("owl", ("Gufo del guardiano", s"Ottieni 4 $gloryPoint; durante il tuo turno puoi ottenere a scelta 1 $gold, 1 Cristallo Solare, o 1 Cristallo Lunare"))
  ).toMap
